...
class Evaluator(object):
    ...
    def eval(self):
        ...
        pics = sorted([args.demo_dir + x for x in files if '.png' in x])[:-1]
...
if __name__ == '__main__':
    ...
    # demo dir
    parser.add_argument('--demo-dir', type=str, default='/mnt/storage/workspace/andreim/nemodrive/upb_data/dataset/test_frames/0d26551740c24c92/',
                        help='demo directory')  
