import math
import numpy as np
import simulator.transformation as transformation
import simulator.steering as steering
from util.reader import Reader


class Simulator(object):
    def __init__(self, reader: Reader, time_penalty: int=6,
                 distance_limit: float = 1., angle_limit: float = 0.1):
        """
        Constructor
